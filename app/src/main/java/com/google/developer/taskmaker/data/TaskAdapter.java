...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskHolder> {
    ...
    public void onBindViewHolder(TaskHolder holder, int position) {
        ...
        String mDescription = mCursor.getString(mCursor.getColumnIndex(DatabaseContract.TaskColumns.DESCRIPTION));
        long mDueDate = mCursor.getLong(mCursor.getColumnIndex(DatabaseContract.TaskColumns.DUE_DATE));
        int mIsComplete = mCursor.getInt(mCursor.getColumnIndex(DatabaseContract.TaskColumns.IS_COMPLETE));
        int mIsPriority = mCursor.getInt(mCursor.getColumnIndex(DatabaseContract.TaskColumns.IS_PRIORITY));
